...
const form = useForm({
    ...
    file: null,
    is_public: Boolean(props.document.is_public),
});
                    ...
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit" class="space-y-6 max-w-2xl">
                            ...
                            <div>
                                ...
                                <FileUpload 
                                    v-model="form.file" 
                                    :current-file-name="document.file_path ? document.file_path.split('/').pop() : null"
                            ...
                            <div class="flex items-center gap-4">
                                <Button :disabled="form.processing">Update Document</Button>
