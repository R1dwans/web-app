    ...
    <AuthenticatedLayout>
        <div class="flex flex-col gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Tambah Staf</h1>
                    <p class="text-muted-foreground">Tambahkan data dosen/tendik/pimpinan baru.</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ImageUpload v-model="form.photo" :error="form.errors.photo" />
                        </CardContent>
                    </Card>
                </div>
            </form>
