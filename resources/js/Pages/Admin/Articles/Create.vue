...
import { Columns2, Columns3, PanelLeft, PanelRight, LayoutTemplate } from 'lucide-vue-next'
...
const createCategory = async () => {
    ...
    try {
        ...
        // Handle validation errors if needed (e.g. unique name)
...
watch(() => form.title, (newTitle) => {
    ...
    // Auto-generate Meta Title if empty or matches previous title
    if (!form.meta_title || form.meta_title === oldTitle) {
        form.meta_title = newTitle;
    }
    oldTitle = newTitle; // Track old title
});
...
watch(() => form.content, (newContent) => {
    ...
    // Only auto-fill if empty or previously auto-filled (simple heuristic: if it matches start of content)
    // For now, simpler: if empty, fill it.
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="title" type="text" v-model="form.title" required autofocus class="text-lg font-semibold py-6" placeholder="Enter article title here..." />
