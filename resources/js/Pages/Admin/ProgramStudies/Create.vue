...
const submit = () => {
    form.post(route('program-studies.store'));
};
</script>

<template>
    <Head title="Create Program Study" />
                    ...
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit" class="space-y-6 max-w-xl">
                            ...
                            <div>
                                ...
                                <Input id="name" type="text" v-model="form.name" placeholder="e.g. Nursing" required autofocus />
                                <InputError class="mt-2" :message="form.errors.name" />
                            </div>

                            <div>
                                <Label for="description">Description</Label>
                                <Textarea id="description" v-model="form.description" placeholder="Brief description of the program study..." />
